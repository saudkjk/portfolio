...
import { TextContainer, ImageContainer, ProjectImage, StyledCard, StyledIcon, MyButton } from './Projects.styled'
    ...
    return (
        <StyledCard key={project.title} data-aos="fade-up" data-aos-duration="1000">
            <TextContainer>
                ...
                <MyButton variant="contained" sx={{ border: '1px solid black' }} href={project.link} target="_blank">
                    Code
                </MyButton>
            </TextContainer>
